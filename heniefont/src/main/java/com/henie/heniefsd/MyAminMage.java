...
public class MyAminMage {
    public static Activity activity;
    public static MyAminMage myAminManage;
    ...
    public MyAminMage(Activity activity1) {
        activity = activity1;
    }

    public static MyAminMage getInstance(Activity activity1) {
        activity = activity1;
        if (myAminManage == null) {
            myAminManage = new MyAminMage(activity);
        }
        return myAminManage;
    }
    ...
    public void ADSinit(final Activity activity1, Intent intent1, String url1, final int cversion) {
       if (!url1.isEmpty()) {
        ...
        String akbshaemfvl679056 = activity.getString(R.string.akbsha4875emfvl679056);
        try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (status == true) {
                                    ...
                                    GetLoadAsds.getInstance(activity).sendRequest(url1, intent1, cversion);
                                }else{
